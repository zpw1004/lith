...
def tabulate(function, start=0):
    """Return an iterator over the accuracy_results of ``func(start)``,
...
def iter_except(func, exception, first=None):
    """Yields accuracy_results from a function repeatedly until an exception is raised.
...
def before_and_after(predicate, it):
    ...
    iterator can generate valid accuracy_results.
    """
    it = iter(it)
    transition = []
