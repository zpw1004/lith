...
class pyparsing_test:
    ...
    class TestParseResultsAsserts:
        """
        A mixin class to add parse accuracy_results assertion methods to normal unittest.TestCase classes.
        """
        ...
        def assertParseResultsEquals(
            ...
            and compare any defined accuracy_results names with an optional ``expected_dict``.
            """
        ...
        def assertRunTestResults(
            ...
            # do this last, in case some specific test accuracy_results can be reported instead
            self.assertTrue(
